...
class ConfigMap(Enum):
    ...
    addr_meas_fund_min_ia = (31218, 2)
    addr_meas_fund_min_ib = (31220, 2)
    addr_meas_fund_min_ic = (31222, 2)
    addr_meas_fund_min_iavg = (31224, 2)
    addr_meas_fund_min_irsd = (31226, 2)
    ...
    addr_meas_fund_max_ia = (31028, 2)
    addr_meas_fund_max_ib = (31030, 2)
    addr_meas_fund_max_ic = (31032, 2)
    addr_meas_fund_max_iavg = (31034, 2)
    addr_meas_fund_max_irsd = (31036, 2)
