...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.widget.setGeometry(QRect(29, 99, 761, 491))
        ...
        self.log_print = QTextEdit(self.widget)
        self.log_print.setObjectName(u"log_print")
        self.log_print.setGeometry(QRect(430, 20, 321, 461))
        self.log_print.setStyleSheet(u"background-color: black; color: white")
        self.log_print.setReadOnly(True)
        self.widget_4 = QWidget(self.widget)
        self.widget_4.setObjectName(u"widget_4")
        self.widget_4.setGeometry(QRect(10, 290, 208, 99))
        self.verticalLayout_3 = QVBoxLayout(self.widget_4)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.layout_step7_2 = QHBoxLayout()
        self.layout_step7_2.setObjectName(u"layout_step7_2")
        self.label_time7_2 = QLabel(self.widget_4)
        self.label_time7_2.setObjectName(u"label_time7_2")
        self.label_time7_2.setFrameShape(QFrame.Shape.Panel)
        self.label_time7_2.setFrameShadow(QFrame.Shadow.Plain)
        self.label_time7_2.setLineWidth(1)
        self.label_time7_2.setMidLineWidth(0)
        self.label_time7_2.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.layout_step7_2.addWidget(self.label_time7_2)

        self.index_1 = QLineEdit(self.widget_4)
        self.index_1.setObjectName(u"index_1")

        self.layout_step7_2.addWidget(self.index_1)


        self.verticalLayout_3.addLayout(self.layout_step7_2)

        self.layout_step7_3 = QHBoxLayout()
        self.layout_step7_3.setObjectName(u"layout_step7_3")
        self.label_time7_3 = QLabel(self.widget_4)
        self.label_time7_3.setObjectName(u"label_time7_3")
        self.label_time7_3.setFrameShape(QFrame.Shape.Panel)
        self.label_time7_3.setFrameShadow(QFrame.Shadow.Plain)
        self.label_time7_3.setLineWidth(1)
        self.label_time7_3.setMidLineWidth(0)
        self.label_time7_3.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.layout_step7_3.addWidget(self.label_time7_3)

        self.index_2 = QLineEdit(self.widget_4)
        self.index_2.setObjectName(u"index_2")

        self.layout_step7_3.addWidget(self.index_2)


        self.verticalLayout_3.addLayout(self.layout_step7_3)

        self.layout_step7_4 = QHBoxLayout()
        self.layout_step7_4.setObjectName(u"layout_step7_4")
        self.label_time7_4 = QLabel(self.widget_4)
        self.label_time7_4.setObjectName(u"label_time7_4")
        self.label_time7_4.setFrameShape(QFrame.Shape.Panel)
        self.label_time7_4.setFrameShadow(QFrame.Shadow.Plain)
        self.label_time7_4.setLineWidth(1)
        self.label_time7_4.setMidLineWidth(0)
        self.label_time7_4.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.layout_step7_4.addWidget(self.label_time7_4)

        self.index_3 = QLineEdit(self.widget_4)
        self.index_3.setObjectName(u"index_3")

        self.layout_step7_4.addWidget(self.index_3)


        self.verticalLayout_3.addLayout(self.layout_step7_4)

        self.widget_2 = QWidget(Form)
        self.widget_2.setObjectName(u"widget_2")
        self.widget_2.setGeometry(QRect(40, 40, 151, 42))
        ...
        self.btn_start.setMaximumSize(QSize(50, 16777215))
        ...
        self.widget_3.setGeometry(QRect(460, 40, 313, 42))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_time7_2.setText(QCoreApplication.translate("Form", u"Index", None))
        self.index_1.setText("")
        self.label_time7_3.setText(QCoreApplication.translate("Form", u"Index-n1", None))
        self.index_2.setText("")
        self.label_time7_4.setText(QCoreApplication.translate("Form", u"Index-n2", None))
        self.index_3.setText("")
